...
- **Edit mode for remaining eigenform types** — TextForm, NumberForm, BooleanForm, ChoiceForm, CheckboxForm, ListForm have full edit mode (label, instruction, config). Remaining types (DateForm, RangeForm, MemoForm, RankForm, SetForm, KeyValueForm, etc.) need edit mode added.
