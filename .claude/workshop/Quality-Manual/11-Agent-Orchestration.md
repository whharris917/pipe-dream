...
The QMS enforces four permission groups. Every agent is assigned to exactly one group. See the [CLI Reference](../qms-cli/docs/cli-reference.md) permission matrix for the full command-to-group mapping.
...
- [CLI Reference](../qms-cli/docs/cli-reference.md) -- Commands available to each role
