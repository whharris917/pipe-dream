---
task_id: task-CR-065-pre_review-v0-1
task_type: REVIEW
...
**If ALL items PASS:**
```
/qms --user qa review CR-065 --recommend --comment "[your structured review]"
```

**If ANY item FAILS:**
```
/qms --user qa review CR-065 --request-updates --comment "[your structured review with findings]"
```
