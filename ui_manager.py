...
class UIManager:
    ...
    def draw(self, screen, font, mode):
        ...
        physics_elements = [
            ...
            self.buttons['thermostat'], self.buttons['boundaries'],
            self.sliders['gravity'], self.sliders['temp'], self.sliders['damping'],
            self.sliders['dt'], self.sliders['speed'], 
