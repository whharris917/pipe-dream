...
# ============================================================
# Force computation: cell traversal (No PBC)
# ============================================================
@njit(fastmath=True)
        ...
        for cy in range(ncell_y):
            ...
            while ii != -1:
                ...
                for dx_cell in (-1, 0, 1):
                    ncx = cx + dx_cell
                    # Check bounds instead of wrapping
                    ...
                    for dy_cell in (-1, 0, 1):
                        ...
                        while jj != -1:
                            if jj > ii:
                                dx = xi - pos_x[jj]
                                dy = yi - pos_y[jj]
                                # No PBC minimum image check here
                                r2 = dx * dx + dy * dy
...
# ============================================================
# Fused Multi-step Kernel (With Reflective Walls)
# ============================================================
@njit(fastmath=True)
def step_pairs_n(
    nsteps,
...
def main():
    ...
    pygame.display.set_caption("2D MD - Particles in a Box (No PBC)")
