...
thermostat = True
# thermostat_steps = 2000  <-- Removed logic dependency on this
damping = np.float32(0.1)  # Softened damping for smoother interaction
...
# Wall Damping (Fraction of velocity retained after bounce)
# 1.0 = Elastic (No energy lost)
# 0.9 = Inelastic (Energy lost)
...
def main():
    ...
    pygame.display.set_caption("2D MD - Particles in a Box + Gravity + Wall Damping")
