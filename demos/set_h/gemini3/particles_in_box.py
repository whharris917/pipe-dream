...
class Slider:
    ...
    def draw(self, screen, font):
        ...
        if self.label == "Steps/Frame (M)": # Integer formatting for M
...
def main():
    ...
    slider_M = Slider(20, ui_start_y + 160, 200, 10, 1.0, 100.0, float(DEFAULT_DRAW_M), "Steps/Frame (M)")
    ...
    ui_elements = [slider_temp, slider_dt, slider_gravity, slider_L, slider_M, btn_thermostat, btn_gravity, btn_draw]
    ...
    def reset_simulation():
        ...
        slider_M.val = float(DEFAULT_DRAW_M)
