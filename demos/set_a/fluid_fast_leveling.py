...
GLOBAL_GRAVITY = 0.50      
BASE_DIFFUSION = 0.90      # Max diffusion for "watery" behavior

# VISCOSITY CONTROL (The Speed of Leveling)
# We crank this up to 20 to ensure the pile collapses instantly across the pipe width
LONGITUDINAL_PASSES = 20   
GRAVITY_PASSES = 4         
...
class BitwisePipe:
    ...
    def update(self, pump_is_on):
        ...
        # SUPER HIGH SPEED SPREADING LOOP (20x)
        # This ensures the fluid propagates across the pipe faster than it fills up.
        for _ in range(LONGITUDINAL_PASSES):
            for i in range(self.lanes):
                state = self.states[i]
...
def main():
    ...
    pygame.display.set_caption("Instant Leveling Demo")
    ...
    while running:
        ...
        screen.blit(font.render("Viscosity = 1/20 (Very Low)", True, COLOR_TEXT), (20, 50))
        screen.blit(font.render(f"Longitudinal Passes: {LONGITUDINAL_PASSES}x", True, (200, 200, 200)), (20, 80))
        screen.blit(font.render("Bottom pipe levels instantly.", True, (200, 200, 200)), (20, 100))
