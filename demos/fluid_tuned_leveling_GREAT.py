...
DEFAULT_WIDTH = 1200
DEFAULT_HEIGHT = 800
PHYSICS_STEPS_PER_FRAME = 60 # High steps for smooth leveling
...
# --- TUNED THERMODYNAMICS ---
# We lowered Repulsion and raised Gravity.
# This makes the fluid "heavier" and less "expansive".
KT = 0.2                # Heat. Allows atoms to jiggle into the wedge shape.
GRAVITY_POTENTIAL = 0.9 # Strong Gravity. Pulls surface down.
INTERACTION_J = 0.01    # Lower Repulsion. Reduces "puffiness".
MU_SOURCE = 5.0         # Source pressure stays high to feed the system.
...
def main():
    ...
    pygame.display.set_caption("Tuned Leveling Physics")
    ...
    while running:
        ...
        screen.blit(font.render("Ratio Adjusted:", True, COLOR_TEXT), (20, 50))
        screen.blit(font.render(f"Interaction J: {INTERACTION_J} (Lower)", True, (200, 200, 200)), (20, 80))
        screen.blit(font.render(f"Gravity G: {GRAVITY_POTENTIAL} (Higher)", True, (200, 200, 200)), (20, 100))
