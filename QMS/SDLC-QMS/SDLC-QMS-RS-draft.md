...
| REQ-SEC-003 | **Owner-Only Restrictions.** The CLI shall restrict checkin, release, revert, and close actions to the document's responsible_user (owner). | Behavioral: Create document as user A; attempt checkin as user B; verify rejection. Repeat for release, revert, close |
