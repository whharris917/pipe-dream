...
revision_summary: 'CR-074: Add REQ-MCP-016 identity collision prevention'
---
...
| REQ-MCP-011 | **Remote Transport Support.** The MCP server shall support stdio transport (default, for subprocess communication), SSE transport (deprecated, for legacy remote HTTP connections), and streamable-http transport (recommended for remote HTTP connections). The transport mode shall be selectable at server startup. |
