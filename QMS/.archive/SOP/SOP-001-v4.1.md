...
revision_summary: Document three-tier metadata architecture (.meta/.audit sidecar
  files)
---
...
| 2.0 | 2026-01-02 | claude | Add user groups, permissions, review outcomes, qms assign/fix commands |
| 3.0 | 2026-01-03 | lead | Replace QMS_USER env var with required --user CLI flag |
| 4.0 | 2026-01-03 | lead | Rename assign --user to --assignees to avoid confusion |
| 4.1 | 2026-01-03 | lead | Document three-tier metadata architecture (.meta/.audit sidecar files) |
