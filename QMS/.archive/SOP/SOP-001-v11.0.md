...
revision_summary: 'CR-014: Add VAR to controlled document types, definitions, and
  naming conventions'
---
...
| **Executable Document** | A document that authorizes implementation activities (CR, INV, CAPA, TP, ER, VAR) |
...
### 8.2 Executable Documents (CR, INV, CAPA, TP, ER, VAR)
