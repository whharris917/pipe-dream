...
revision_summary: 'CR-089: Add VR to scope/definitions (Sections 2-3), VR column to
  EI table (Section 4.2), new Section 9C for VR lifecycle, VR gate in Section 10'
---
...
create (IN_EXECUTION v1.0, checked out)
  → fill in contemporaneously during testing
  → checkin
