...
revision_summary: Add document cancel and retire functionality (Section 8.3, 9.7,
  13.5)
---
...
revision_summary: Brief description of what changed in this revision
---
```

- **title**: Set at document creation, rarely changes
- **revision_summary**: Updated each revision cycle to describe changes
...
### 8.1 Non-Executable Documents (SOP, RS, DS, CS, RTM, OQ)
...
### 8.2 Executable Documents (CR, INV, CAPA, TP, ER)
...
| Command | Description |
|---------|-------------|
| `qms --user {USER} route {DOC_ID} --review` | Route for review |
| `qms --user {USER} route {DOC_ID} --pre-review` | Route for pre-review (executable) |
| `qms --user {USER} route {DOC_ID} --post-review` | Route for post-review (executable) |
| `qms --user {USER} route {DOC_ID} --approval` | Route for approval |
| `qms --user {USER} route {DOC_ID} --pre-approval` | Route for pre-approval (executable) |
| `qms --user {USER} route {DOC_ID} --post-approval` | Route for post-approval (executable) |
...
| `qms --user {USER} route {DOC_ID} --post-approval --retire` | Route executable doc for retirement |
