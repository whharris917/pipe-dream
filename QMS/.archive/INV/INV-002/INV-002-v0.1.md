...
|----|-------------|--------|----------|-----------|
| EI-1 | Document findings (this INV) | PENDING | - | - |
| EI-2 | Obtain QA acknowledgment of findings | PENDING | - | - |
| EI-3 | Create CR for CAPA-001 (add revision_summary to SOP-005) | PENDING | - | CR-XXX |
| EI-4 | Execute CAPA-001 | PENDING | - | - |
| EI-5 | Evaluate CAPA-002 and CAPA-003 for implementation | PENDING | - | - |
...
- **SOP-005**: Subject document (EFFECTIVE, nonconforming)
