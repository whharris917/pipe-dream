...
|------|------|-------------|----------------|---------|---------------------|
| INV-006-CAPA-001 | Corrective | Verify both environments are clean and consistent | [IMPLEMENTATION] | [Pass/Fail] | [VERIFIER] - [DATE] |
| INV-006-CAPA-002 | Corrective | Re-execute VAR-005 with correct target (test-env) | [IMPLEMENTATION] | [Pass/Fail] | [VERIFIER] - [DATE] |
