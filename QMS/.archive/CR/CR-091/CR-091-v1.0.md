...
|----|------------------|----|-------------------|--------------|---------------------|
| EI-1 | Pre-execution baseline: commit and push pipe-dream and qms-cli | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Create execution branch `cr-091-interaction-system` in qms-cli from main | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Implement template parser (`interact_parser.py`) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Implement source data model (`interact_source.py`) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Implement interaction engine (`interact_engine.py`) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Implement compilation engine (`interact_compiler.py`) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-7 | Implement `qms interact` CLI command (`commands/interact.py`, `qms.py`) with all flags including atomic commits | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-8 | Modify checkout/checkin/read/create for interactive documents | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-9 | Add `qms_interact` MCP tool (`qms_mcp/tools.py`) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-10 | Author and deploy TEMPLATE-VR v3 (interactive) as seed template | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-11 | Write qualification tests for REQ-INT-001 through REQ-INT-022; run full test suite; record qualified commit | Yes | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-12 | Update SDLC-QMS-RS: add REQ-INT section (22 requirements) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-13 | Update SDLC-QMS-RTM: map REQ-INT requirements to qualification tests, record new qualified baseline | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-14 | Route RS and RTM through review/approval to EFFECTIVE | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-15 | Merge qms-cli execution branch to main (`--no-ff`, merge gate) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-16 | Update SOP-004: add Section 12 (Interactive Document Authoring) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-17 | Update TEMPLATE-VR in QMS/TEMPLATE/ (replace with v3 interactive version) | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-18 | Route SOP-004 and TEMPLATE-VR through review/approval to EFFECTIVE | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-19 | Post-execution baseline: commit and push pipe-dream and qms-cli | | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
