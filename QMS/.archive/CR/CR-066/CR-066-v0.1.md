...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Create PTY Manager module (`pty_manager.py`), add config and model fields | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Integrate PTY Manager into Hub agent lifecycle | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Add `agent-hub attach <id>` CLI command | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Update README, run manual integration tests | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
