...
|----|-------------|--------|----------|-----------|
| EI-1 | Create SOP-005 via QMS | PENDING | - | - |
| EI-2 | Draft SOP-005 content | PENDING | - | - |
| EI-3 | Checkin SOP-005 | PENDING | - | - |
| EI-4 | Route SOP-005 for review and approval | PENDING | - | - |
| EI-5 | Verify SOP-005 becomes EFFECTIVE | PENDING | - | - |
