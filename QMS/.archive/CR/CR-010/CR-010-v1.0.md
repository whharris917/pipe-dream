---
title: 'Create SOP-005: Code Governance'
---

# CR-010: Create SOP-005: Code Governance

## 1. Purpose

Establish a new Standard Operating Procedure (SOP-005) that defines how source code is governed within the QMS framework, including development models, version control, traceability, and the relationship between code and controlled documents.

---

## 2. Scope

This change creates a new document:
- **SOP-005: Code Governance** — Defines the governance framework for all source code in the Pipe Dream project
...
The Pipe Dream project includes both controlled documents (SOPs, CRs, specifications) and source code (application code, QMS infrastructure code). While document governance is well-defined in SOP-001 through SOP-004, there is no formal procedure defining how code changes are governed within the QMS framework.

**Gap Identified:**

The QMS currently lacks procedures for:
- When code changes require CRs vs. when they can proceed outside formal change control
- How code versions relate to controlled documents (traceability)
- How new systems are brought into the governed environment
- How code releases are versioned and tracked

**Proposed Solution:**

Create SOP-005: Code Governance that consolidates the code governance framework into a formal, controlled procedure.
...
|----|-------------|--------|----------|-----------|
| EI-1 | Create SOP-005 via QMS | COMPLETE | SOP-005 v0.1 created | - |
| EI-2 | Draft SOP-005 content | COMPLETE | 11 sections, 349 lines | - |
| EI-3 | Checkin SOP-005 | COMPLETE | SOP-005 v0.1 checked in | - |
| EI-4 | Route SOP-005 for review and approval | COMPLETE | QA reviewed and approved | - |
| EI-5 | Verify SOP-005 becomes EFFECTIVE | COMPLETE | SOP-005 v1.0 EFFECTIVE | - |

---

## 5. Proposed Content for SOP-005

The following is the proposed full content for SOP-005: Code Governance.

---

### SOP-005 Section 1: Purpose
...
### SOP-005 Section 4: Separation of Concerns
...
### SOP-005 Section 5: Repository Structure
...
3. **Bidirectional traceability:** CRs reference code files and commits; SDLC documents (DS, RTM) reference the System Release and Qualified Commit

---

### SOP-005 Section 6: Code Reference Format
...
### SOP-005 Section 7: Development Models
...
### SOP-005 Section 8: Adopting a Genesis Sandbox System into Production
...
### SOP-005 Section 9: System Release Versioning
...
### SOP-005 Section 10: Traceability Model
...
### SOP-005 Section 11: Summary — When to Use What
...
1. SOP-005 is created and becomes EFFECTIVE
2. All sections are present and complete
3. Diagrams render correctly
4. Procedures are actionable and unambiguous
