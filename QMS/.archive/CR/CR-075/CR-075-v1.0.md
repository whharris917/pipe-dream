...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Establish test environment: create execution branch in qms-cli, verify test baseline | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Update SDLC-QMS-RS: revise REQ-MCP-009, REQ-MCP-011, REQ-MCP-014, REQ-MCP-015, REQ-MCP-016, and Section 5.4 per Section 5.3 of this CR; route through review/approval to EFFECTIVE | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Implement changes: modify `resolve_identity()` for header-based mode selection; update `.mcp.json` for HTTP transport; add/update qualification tests | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Run qualification: execute full test suite, verify CI, document results | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Update SDLC-QMS-RTM: update verification entries for REQ-MCP-015 and REQ-MCP-016 with test references and qualified baseline; route through review/approval to EFFECTIVE | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Merge to main: PR in qms-cli, update submodule pointer in pipe-dream, push | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
