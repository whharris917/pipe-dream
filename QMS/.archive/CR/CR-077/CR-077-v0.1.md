...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Fix Git MCP command injection: replace shell=True with shlex parsing and shell=False | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Restrict CORS origins to GUI-specific origins | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Check ensureHub() return value before WebSocket connect | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Add React ErrorBoundary to GUI | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
