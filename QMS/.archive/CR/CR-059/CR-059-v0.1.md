...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Modify `docker/.claude-settings.json`: add permissions block per Section 5.1 | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Modify `docker/entrypoint.sh`: remove `projects/` and `history.jsonl` wipes per Section 5.2; update echo message | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Launch containerized session and verify MCP connectivity on first startup | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Verify QMS and Git MCP tools execute without permission prompts | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Verify Bash allow list commands execute without prompts | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Verify deny rules block direct writes to QMS paths | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-7 | Stop container, restart, verify `projects/` persists and MCP connects successfully | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
