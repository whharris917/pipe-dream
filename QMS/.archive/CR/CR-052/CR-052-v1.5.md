...
revision_summary: 'Session 2026-02-03: Auth persistence FIXED via CLAUDE_CONFIG_DIR.
  MCP auto-connect remains unresolved - appears to be Claude Code limitation with
  HTTP transport. User must run /mcp once per session. Significant UX improvement
  achieved.'
---
