...
revision_summary: 'Session 2026-02-03: Both issues RESOLVED. Auth persistence via
  CLAUDE_CONFIG_DIR env var + named volume (per GitHub #1736). MCP auto-connect via
  user-scoped config initialized by entrypoint script. Ready for final testing.'
---
