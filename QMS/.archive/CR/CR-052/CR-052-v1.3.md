...
revision_summary: 'Session 2026-02-03: MCP auto-connect issue RESOLVED - root cause
  was project-scoped servers require approval tied to project path. Solution: pre-configure
  user-scoped MCP server in container. Auth issue still under investigation.'
---
...
| `docker/docker-compose.yml` | Modify | Add `working_dir: /pipe-dream`, credentials mount to rw |
| `docker/Dockerfile` | Modify | Add COPY for user-scoped MCP config |
