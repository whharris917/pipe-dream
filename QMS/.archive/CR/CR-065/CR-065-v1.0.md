...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Setup test environment: create shared branch `cr-049-065-requalification` (shared with CR-049) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
...
| EI-4 | Run full test suite, push to dev branch, verify CI passes (combined with CR-049) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Update SDLC-QMS-RTM qualified baseline, route for review/approval (combined with CR-049) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Merge PR to main, update submodule pointer in parent repo (combined with CR-049) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
