...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Rewrite `pty_manager.py` for tmux control mode (attach, read loop, write, resize, octal decoder) | [EXECUTION_SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Simplify `useHubConnection.ts` — remove workaround escape processing, keep mouse tracking and clear-scrollback stripping | [EXECUTION_SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Create unit tests for control mode parsing (`test_control_mode.py`) | [EXECUTION_SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
