...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Update RS-draft.md: REQ-DOC-003 change "superseded versions" to "archived versions" | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-2 | Update RS-draft.md: REQ-WF-002 remove "SUPERSEDED and" from terminal states | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-3 | Update RS-draft.md: REQ-WF-011 remove "SUPERSEDED," from list | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-4 | Update qms_config.py: Remove SUPERSEDED enum value and transitions | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-5 | Update qms_schema.py: Remove SUPERSEDED from status list | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-6 | Update qms_meta.py: Remove "supersedes" field from initial meta | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-7 | Update migrate.py: Remove supersedes migration line | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-8 | Delete test_terminal_state_superseded from both test file copies | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-9 | Fix BUG-001: Add ER to parent-requiring types in create.py | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-10 | Fix BUG-002: Add EVENT_ASSIGN and log_assign() to qms_audit.py | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-11 | Fix BUG-002: Call log_assign() in assign.py | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-12 | Fix BUG-003: Add missing fields to task generation in prompts.py | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-13 | Fix BUG-003: Update route.py to pass title, status, responsible_user | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-14 | Fix BUG-003: Update assign.py to pass title, status, responsible_user | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-15 | Fix BUG-004: Update find_project_root() to prioritize qms.config.json | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-16 | Remove xfail markers from fixed tests | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-17 | Run qualification suite, verify 123/123 pass | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
| EI-18 | Update RTM-draft.md to reflect test fixes | [SUMMARY] | [PASS/FAIL] | [PERFORMER] — [DATE] |
