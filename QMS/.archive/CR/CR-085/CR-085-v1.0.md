...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Update SOP-004 Section 5: add pre-execution commit requirement. Checkout, edit, checkin, route review/approval to EFFECTIVE | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Update SOP-002 Section 7.2: add commit/push as step 1, renumber existing steps. Checkout, edit, checkin, route review/approval to EFFECTIVE | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Update TEMPLATE-CR: add pre-execution commit note to execution instructions comment. Checkout, edit, checkin, route review/approval to EFFECTIVE. Align seed copy. | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
