...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Create `docker/scripts/mcp_proxy.py` — stdio-to-HTTP proxy with retry logic, configurable headers, and CLI arguments | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Update `docker/.mcp.json` to use command/stdio transport via the proxy | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Update `docker/Dockerfile` to copy proxy script and install `httpx` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Simplify `docker/entrypoint.sh` — remove HTTP health checks, handshake warm-up, and sleep delay | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Validate MCP auto-connect reliability: 30+ container launches, target 100% success | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Test MCP tool invocations (qms_inbox, git_exec) from inside the container | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
