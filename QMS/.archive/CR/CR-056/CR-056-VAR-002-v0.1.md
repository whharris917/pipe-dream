...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Delete the five superseded launcher scripts | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Verify launch.sh still works after deletion (single-agent smoke test) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
