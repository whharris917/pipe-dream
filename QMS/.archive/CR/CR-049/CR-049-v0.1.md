...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Setup test environment: create shared branch `cr-049-065-requalification` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | RS update: add `qms_withdraw` to REQ-MCP-004, route for review/approval | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Implement `qms_withdraw` in `qms_mcp/tools.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Add `qms_withdraw` equivalence test, update tool count assertion (19 -> 20) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Run full test suite, push to dev branch, verify CI passes (combined with CR-065) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Update SDLC-QMS-RTM qualified baseline, route for review/approval (combined with CR-065) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-7 | Merge PR to main, update submodule pointer in parent repo (combined with CR-065) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
