...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Create `git-mcp/` directory structure and `server.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Implement validation logic (submodule + destructive patterns) | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Create `requirements.txt` and `__init__.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Test server locally on host | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Create `docker/scripts/start-git-mcp.sh` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Update `docker/.mcp.json` with git endpoint | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-7 | Test from inside container | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-8 | Update `docker/README.md` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-9 | Update `CLAUDE.md` with git MCP usage | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
