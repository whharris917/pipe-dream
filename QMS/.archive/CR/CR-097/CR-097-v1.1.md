...
| EI-4 | Integration verification: compile VR and inspect output | CR-097-VR-001 | Compiled sample VR with 2 steps. Labels (**Instructions:**, **Expected:**, **Actual:**, **Outcome:**) all present. Instructions use > blockquote. Attribution on separate lines. Formatting consistent with Objective/Prerequisites sections. | Pass | claude - 2026-02-22 |
