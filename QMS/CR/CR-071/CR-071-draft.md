...
|----|------------------|-------------------|--------------|---------------------|
| EI-1 | Modify `hub.py` to raise RuntimeError when agent is already RUNNING | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-2 | Modify `container.py` to guard against removing running containers | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-3 | Expand `AgentSummary` in `models.py` and populate in `routes.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-4 | Add `classify_container()` helper to `services.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-5 | Rewrite `status` command in `cli.py` with unified three-section output | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-6 | Remove `services` command from `cli.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-7 | Add HTTP 409 handling to `launch` command in `cli.py` | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
| EI-8 | Manual UAT verification of all test scenarios | [SUMMARY] | [Pass/Fail] | [PERFORMER] - [DATE] |
