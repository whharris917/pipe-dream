...
|------|------|-------------|----------------|---------|---------------------|
| INV-004-CAPA-001 | Corrective | Fix load_template_for_type() to include revision_summary | CR-021 (CLOSED) - Modified qms.py lines 819-823 to always include revision_summary | Pass | claude - 2026-01-08 |
